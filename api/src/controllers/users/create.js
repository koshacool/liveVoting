...
const { ADMIN } = require('../../middleware/permission-checker/roles');
const EmailSender = require('../../utils/EmailSender');

const registerUser = (User, user, password) => new Promise((resolve, reject) =>
  User.register(user, password, (err, updatedTank) => err && reject(err) || resolve(updatedTank)));

const create = ({ User, Image, File }) => async (req, res, next) => {
  try {
